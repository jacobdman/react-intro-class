...
class Calculator extends Component {
    ...
    onNumberClick = (num) => {
      if (this.state.operator && this.state.valueA) {
        this.setState({valueB: this.returnConcatValue(this.state.valueB, num)})
      } else {
        this.setState({valueA: this.returnConcatValue(this.state.valueA, num)})
    }
  }
    returnConcatValue = (oldVal,num) => {
      if (!oldVal) {
        return num
      } else {
            ...
            <div id="calculator-container">
              ...
              <div id="calculator-mask" className="remove-highlight">
                <div className="output">
                  <span className="total">{this.state.operator && this.state.valueB ? this.state.valueB : this.state.valueA}</span>
                </div>
